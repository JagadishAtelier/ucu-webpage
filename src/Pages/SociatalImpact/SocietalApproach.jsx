    ...
    <div className='captital-campus-content-sec my-4'>
        ...
        <div className='d-flex gap-3 flex-lg-row flex-md-row flex-column my-4'>
          <p className='col-lg-9 col-md-7 fw-normal fs-6'>
            Explore UCU's approach to creating a positive and sustainable societal impact with our Dean, Varun Nagaraj. In this video, he highlights the various ways UCU makes a difference, including engaging with large-scale communities such as non-profits, the development sector, FinTech and finance professionals, and entrepreneurs to improve practices and build capacity. Additionally, UCU focuses on creating socially conscious leaders, focusing on research that is relevant to society, and extending its impact internationally by chairing the UN PRME India Chapter and welcoming international universities and students to participate in our immersive social programmes.</p>
