    ...
    <div className='captital-campus-content-sec mt-5'>
        ...
        <div className='coe-benfactor-d-grid mt-4'>
                {peopleData.map((item,index)=>(
                    <div className='d-flex align-items-center gap-4 coe-benfactor-grid-div shadow'>
                        <img src={item.image} className='col-5'/>
                        <div className='col-6'>
                        <p className='fw-bold' style={{color:"#5ac501"}}>{item.name}</p>
                        <p className=''>{item.year}</p>
                        <p className='mb-0'>{item.prof}</p>
                        </div>
                    </div>
                ))}
        </div>
