    ...
    <section className="pgdm-section">
      <div className="container my-4 text-justifys">
        ...
        <p className="text-justifys">
          ...
          date. This system ensures a seamless transition from full-time
          employment to full-time management education
        </p>
        <p>
          The program looks for individuals with{" "}
          <strong>
            strong academic records, relevant professional experience, diverse
            achievements, and wide-ranging interests
          </strong>
          —professionals committed to driving meaningful progress in their
          careers.
        </p>
        <div className="mt-4">
          {/* {data.map((item, index) => (
        ...
        <CarresRobatKeyDates />
        <CareerRobatInterviewProcess />
        <CareerRobatAcademicAbilities />
        <CareerRobatApplicationGuidelines />
        <CareerRobatEssay />
        <CareerRobatEvaluationProcess />
        {/* <div className="">
          <PGPMBottomBanner />
        </div> */}
      </div>
