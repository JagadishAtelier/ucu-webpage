...
function CAPSection() {
    return (
        <div className="captital-campus-content-sec mt-4">
            <h1 className="text-center display-4 fw-bold">Career <span style={{color:"#5ac501"}}> Acceleration </span> Program <span style={{color:"#5ac501"}}>(CAP)</span></h1>
            <p className="text-center pt">
                ...
                trends. CAP bridges classroom learning with real-world leadership,
                enhancing placement readiness and strategic exposure.
            </p>
