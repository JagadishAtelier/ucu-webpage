                    ...
                    <div className="row">
                        <div className="col-lg-8" data-aos="fade-right">
                            <h1 className="display-3 fw-bold mb-4">
                                <span style={{ color: "#5ac501" }}>UCU Chennai</span> in the Media
                            </h1>
                            <p className="lead opacity-90 mb-0" style={{ maxWidth: '600px' }}>
                                Stay updated with the latest news, press releases, and media mentions 
                                highlighting UCU's impact on the global educational landscape.
                            </p>
                        </div>
                    </div>
                </div>
