...
function OverviewAbout() {
    ...
    return (
        <div >
            ...
            {!isPGDM && !isPGPM && (
                <>
                    <p className="font-weight-normal" style={{ textAlign: "justify" }}>The two-year PGDM is meticulously designed for high-potential professionals with less than three years of work experience, poised to lead in fast-evolving global and emerging markets. With a sharp focus on industry integration and outcome-driven learning, the program blends academic rigor with real-world relevance.</p>
