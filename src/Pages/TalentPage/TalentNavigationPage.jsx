...
import BatchProfileClass from '../BatchProfilePage/BatchProfileClass'
import BPCWorkExp from '../BatchProfilePage/BPCWorkExp'
import BPPSpecializations from '../BatchProfilePage/BPPSpecializations'
import { useLocation } from "react-router-dom";
function TalentNavigationPage() {
    const location = useLocation();
    const selectedHead = location.state?.head || "Talent Details";
    return (
        <div>
            <Navbar />
            <div
...
export default TalentNavigationPage