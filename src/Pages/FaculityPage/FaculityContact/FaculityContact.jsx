...
function FaculityContact() {
  return (
    <div className='mt-lg-5 d-flex flex-column flex-lg-row gap-lg-5 px-4 px-lg-4 py-5 py-lg-5 align-items-lg-center'
    style={{
    ...
    >
      <div className='col-12 col-lg-6 d-flex flex-column flex-lg-column gap-3 text-white'>
        ...
        <h1 className='display-4 fw-bold col-10'>Contact Our Team for <span style={{ color: "#C19A6B" }}>Support</span> Today</h1>
