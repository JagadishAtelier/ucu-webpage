...
const PGPMFLEXAdmissionEligible = () => {
    return (
            ...
            <Container>
                ...
                <header className="PGPMFLEX-admission-eligible-header text-center mb-5">
                    <h1 className="display-5 fw-bold">
                        PGPM FLEX <span style={{ color: "#5ac501" }}> Eligibility</span>
                    </h1>
                    <p className="mx-auto" style={{ maxWidth: '600px' }}>Prerequisites for applying to the PGPM Flex program</p>
                </header>
                        ...
                        <div className="PGPMFLEX-admission-eligible-card theme-blue">
                            <div className="PGPMFLEX-card-body">
                                ...
                                <p className="PGPMFLEX-card-desc">
                                    Bachelor’s degree or equivalent in any discipline, with a consistent academic track record.
                                </p>
                    ...
                    <Col md={6} lg={3}>
                        <div className="PGPMFLEX-admission-eligible-card theme-orange">
                            <div className="PGPMFLEX-card-body">
                                ...
                                <p className="PGPMFLEX-card-desc">
                                    Ideally for candidates with work experience. Exceptional students may be considered.
                                </p>
                                <div className="PGPMFLEX-tags-container">
                    ...
                    <Col md={6} lg={3}>
                        <div className="PGPMFLEX-admission-eligible-card theme-purple">
                            <div className="PGPMFLEX-card-body">
                                ...
                                <p className="PGPMFLEX-card-desc">
                                    We accept various competitive exam scores or the UCU Aptitude Test.
                                </p>
                                <div className="PGPMFLEX-tags-container">
                    ...
                    <Col md={6} lg={3}>
                        <div className="PGPMFLEX-admission-eligible-card theme-green">
                            <div className="PGPMFLEX-card-body">
                                ...
                                <p className="PGPMFLEX-card-desc">
                                    Additional requirements for self-sponsored and other candidates.
                                </p>
                                <div className="PGPMFLEX-tags-container">
...
export default PGPMFLEXAdmissionEligible;