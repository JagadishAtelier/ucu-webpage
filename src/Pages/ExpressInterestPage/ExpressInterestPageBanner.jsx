...
function ExpressInterestPageBanner() {
    const { getKeyValue, getImage } = useFrontendContent("expression-of-interest");

    const title = getKeyValue("ExpressInterestPageBanner", "title", "Expression of Interest");
    const bgImage = getImage("ExpressInterestPageBanner", 0, "https://img.freepik.com/premium-photo/happy-graduate-giving-thumbs-up_1152821-13729.jpg?uid=R175611833&ga=GA1.1.1276842385.1760516584&semt=ais_hybrid&w=740&q=80");
