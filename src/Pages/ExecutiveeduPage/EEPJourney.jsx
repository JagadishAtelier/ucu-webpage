        ...
        <div className="row g-4">
          {data.map((item, index) => (
            <div className="col-lg-4 col-md-6 col-sm-12 mx-auto" key={index}>
              <div className="offer-card shadow h-100 text-center d-flex flex-column">
                ...
                {/* Make content area grow and push button to bottom */}
                <div className="flex-grow-1 d-flex flex-column justify-content-between text-start p-3">
                  <p>{item.para}</p>
