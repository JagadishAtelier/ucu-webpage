        ...
        <section className="container p-3 mx-auto  my-1">
            ...
            <div className="fee-info bg-light p-3 rounded">
                ...
                <div className="fee-details">
                    ...
                    <p>
                        The tuition and program fee is <strong> INR 10,00,000*</strong>.
                    </p>
                    <p>
                        This fee is not inclusive of accommodation and other expenses (if applicable for contact weeks). This includes only the tuition fee and is subject to revision.
                    </p>
                </div>
            </div>
