...
function BlogPageBanner() {
    const { getKeyValue, getImage } = useFrontendContent("blog");

    const title = getKeyValue("BlogPageBanner", "title", "UCU Blog");
    const bgImage = getImage("BlogPageBanner", 0, "https://cgsm.org/wp-content/uploads/2023/12/48047178498_59f3a415d8_o-1-resized-min.jpg");
