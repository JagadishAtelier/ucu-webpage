    ...
    return (
        <div id="apply" className="NEWADMCAREER-section">
            <Container className="text-center NEWADMCAREER-container">
                <h3 className="NEWADMCAREER-title">
                    Ready to Transform Your Career?
                </h3>
                <p className="NEWADMCAREER-subtitle">
                ...
                {/* Help Card */}
                <div className="NEWADMCAREER-help-card mx-auto">
                    ...
                    <div className="d-flex flex-column flex-sm-row justify-content-center align-items-center gap-3 NEWADMCAREER-contact">
                        <a href="tel:+911234567890" className="NEWADMCAREER-contact-link d-flex gap-3 align-items-center">
                            <i className="fas fa-phone"></i>
                            +91 123 456 7890
                        </a>
                        <a href="mailto:admissions@ucu.edu" className="NEWADMCAREER-contact-link d-flex gap-3 align-items-center">
