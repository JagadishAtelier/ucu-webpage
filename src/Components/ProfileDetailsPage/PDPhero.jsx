...
function PDPhero() {
  ...
  return (
    ...
    <Navbar/>
      <div
        className="d-flex flex-column flex-lg-row align-items-center justify-content-center justify-content-lg-center text-center text-lg-start py-4 px-3 p-lg-5 p-lg-7 bg-darkblue"
        style={{
        ...
        <div className="bg-white d-flex flex-column flex-md-row flex-lg-row gap-5 mx-lg-5 hero-white-container align-items-lg-center">
          ...
          <div className="d-flex flex-column flex-lg-column gap-1 text-lg-left ms-lg-4 align-items-start text-start">
            ...
            <ul className="education-li-list pdp-sub li">
              <li>
                PhD in Customer Experience Management, Dr RML Avadh University,
                India
              </li>
              <li>
                PhD in Customer Experience Management, Dr RML Avadh University,
