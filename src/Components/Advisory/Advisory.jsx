...
import sarathy from "../../Assets/aac/sathish.jpeg";
import bala from "../../Assets/aac/bala.jpeg";
...
const councils = [
  {
    ...
    gridHead: (
      <>
        Meet Our <span className="color-highlight">Business Advisors</span>
      </>
    ),
  ...
  },
  {
    ...
    gridHead: (
      <>
        Meet Our <span className="color-highlight">Academic Advisors</span>
      </>
    ),
    ...
    staff: [
      {
        ...
        comLogo:
          "https://media.licdn.com/dms/image/v2/C4D0BAQELd1pE6OBd5g/company-logo_200_200/company-logo_200_200/0/1630513284225/pimsr_logo?e=2147483647&v=beta&t=cIscRSSwioTsralzuE4wmq6lI4N398vWazVxprGfpUA",
      },
      {
        image: aacImage2,
      ...
      },
      {
        ...
        comLogo:
          "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSWtJ-Xp_Xh77xKqcdXrS_b-4N5sX44xEHymg&s",
      },
      {
        image: aacImage4,
        ...
        // comText : "Great Lakes Institute of Management, Chennai",
        linkedIn:
          "https://www.linkedin.com/in/rangamannar-veeravalli-04a39320/",
      ...
      {
        image: "https://www.ximr.ac.in/Content/images/vaidyanathan.png",
  ...
  },
  {
    ...
    gridHead: (
      <>
        Meet Our <span className="color-highlight">HR Advisors</span>
      </>
    ),
  ...
  },
  {
    ...
    gridHead: (
      <>
        Meet Our <span className="color-highlight">Young CEOs</span>
      </>
    ),
    ...
    staff: [
      {
        ...
        comLogo:
          "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRgzfRRIqFoGxJZjUeJhe95-yObY0tSAU0oEw&s",
      },
      {
        image: yccImg2,
        name: "Ashish Prasad",
        prof: "A&M",
        comLogo:
          "https://www.bvca.co.uk/static/de9585cd-10c6-4d0d-ace88e44607b74fd/Alvarez-Marsal-Europe-LLP.jpg",
      },
      {
        image: yccImg3,
        name: "Aparna S.",
  ...
  },
  {
    ...
    gridHead: (
      <>
        Meet Our <span className="color-highlight">Rising Leaders'</span>
      </>
    ),
    ...
    staff: [
      {
        ...
        // prof : "Founder, CU"
        comLogo:
          "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQgrkada84btevykP_-yrqs0YXM_YclNrdZMg&s",
      },
      {
        image: rlcImg2,
        name: "Manikandan M.",
        ...
        comLogo:
          "https://marketplace.commercetools.com/img/containers/assets/pp_h_rgb_450-450.png/b0735facc519b33d6ceb1a7133fa77ad.png",
      },
      {
        image: rlcImg3,
        name: "Ajit Bhardwaj",
  ...
  },
  {
    ...
    gridHead: (
      <>
        Meet Our{" "}
        <span className="color-highlight">Administrative Committee</span>
      </>
    ),
    ...
    sec2Para:
      "At the forefront of the Universities strategic direction stands our esteemed Business Advisory Council (BAC). Comprised of luminaries holding influential leadership positions across diverse industries, the BAC provides invaluable insights and forward-thinking guidance. These accomplished executives contribute their unparalleled real-world experience, ensuring the Universities initiatives and member institutions remain acutely attuned to the dynamic demands of the global marketplace. The BAC serves as a powerful nexus between academia and industry, fostering a symbiotic relationship that shapes curriculum relevance, anticipates future talent needs, and ultimately empowers the next generation of business leaders. Their strategic counsel is instrumental in driving the Consortium's mission to elevate business education and foster sustainable growth.",
    staff: [
      { image: image1, name: "Dr. M. Balaji (BALA)", prof: "Founder, CU" },
      {
        image: image2,
        name: "Ritwick Banerjea",
        prof: "Student Mentorship & Welfare",
  ...
  },
  {
    ...
    sec2Para:
      "Our Brand Ambassadors are distinguished alumni, thought leaders, and accomplished professionals who represent the values and vision of the university on a global stage. They serve as inspiring role models for students by sharing their success stories, industry expertise, and real-world experiences. Through their active engagement in mentoring, networking, and advocacy, Brand Ambassadors strengthen the university’s reputation and foster meaningful connections between academia, industry, and society. By embodying the spirit of excellence, innovation, and leadership, they play a vital role in enhancing the university’s visibility and influence worldwide.",
    staff: [
      // { image :image1,
      //   name :"Dr. M. Balaji (BALA)",
      //   prof : "Founder, CU"
  ...
  },
  {
    ...
    sec2Para:
      "The FinTech Advisory Council (FTAC) brings together financial leaders, technology innovators, and academic experts to guide the university in advancing education and research at the intersection of finance and technology. The council provides strategic insights on digital banking, blockchain, artificial intelligence in finance, and emerging financial models, ensuring students gain exposure to cutting-edge industry practices. FTAC also advises on curriculum development, industry partnerships, and experiential learning opportunities, enabling students to build the skills needed to thrive in the rapidly evolving FinTech ecosystem. By fostering innovation and real-world application, the council helps prepare graduates to become future-ready leaders in the digital finance landscape.",
    staff: [
      // { image :image1,
      //   name :"Dr. M. Balaji (BALA)",
      //   prof : "Founder, CU"
  ...
  },
  {
    ...
    sec2Para:
      "The Mobility & Sustainability Advisory Council (MSAC) brings together global experts, industry leaders, and academic professionals to guide the university in advancing sustainable practices and innovative mobility solutions. The council provides strategic insights on clean energy, smart transportation, climate action, and sustainable urban development, ensuring that students are prepared to address pressing environmental and societal challenges. By advising on curriculum enrichment, research initiatives, and industry collaborations, MSAC fosters innovation and equips students with the knowledge and skills needed to create sustainable, future-ready solutions. Through its efforts, the council supports the university’s mission of shaping responsible leaders committed to building a greener and more resilient world.",
    staff: [
      // { image :image1,
      //   name :"Dr. M. Balaji (BALA)",
      //   prof : "Founder, CU"
  ...
  },
  {
    ...
    sec2Para:
      "The Consulting Advisory Council (ConAC) is a network of seasoned consultants, industry strategists, and academic professionals who collaborate with the university to enhance its consulting education and career development initiatives. The council provides valuable perspectives on problem-solving frameworks, business transformation strategies, digital consulting, and client engagement practices. By advising on curriculum design, case-based learning, and industry projects, ConAC ensures that students gain both analytical expertise and practical consulting experience. Through its guidance, the council helps prepare graduates to excel in management consulting, strategy, and advisory roles, equipping them to deliver impactful solutions in dynamic business environments.",
    staff: [
      // { image :image1,
      //   name :"Dr. M. Balaji (BALA)",
      //   prof : "Founder, CU"
