...
const functionalData = [
  { image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8c2FsZXN8ZW58MHx8MHx8fDA%3D",
     heading: "Sales",
     link:"/SalesDiplamo",
     para: `UCU’s Diploma Programs are crafted to be truly distinctive — designed to fast‑track careers by equipping learners with sharp, industry‑ready skills that deliver immediate impact.` },
  { image: "https://plus.unsplash.com/premium_photo-1690302394250-f3e7626a01b0?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NDF8fHByb2R1Y3QlMjBtYW5hZ2VtZW50fGVufDB8fDB8fHww",
     ...
     para: `  Build, launch, and lead breakthrough products with cross-functional expertise and market-first thinking` },
  { image: "https://media.istockphoto.com/id/1435605327/photo/cybersecurity-concept-global-network-security-technology-business-people-protect-personal.webp?a=1&b=1&s=612x612&w=0&k=20&c=Reqkqf1qILOYmckRT5y1B9pL-hZuBWl1FbXTrWnoiGw=",
     heading: "Cyber Security",
      ...
      para: `Protect the digital frontier with cutting-edge skills in risk, resilience, and cyber intelligence` },
  ...
  //     para: ` Drive growth & enhance brand value in the digital age through data-led storytelling and performance marketing mastery  ` },
  { image: "https://images.unsplash.com/photo-1617906647113-0b8b7f262c6c?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MzB8fE1vYmlsaXR5fGVufDB8fDB8fHww",
     heading: "Digital Marketing & AI",
          link:"/program/dm-ai",
      para: `Shape the future of smart, sustainable ecosystems with innovation at the intersection of tech and impact` },
  { image: "https://media.istockphoto.com/id/2160707342/photo/making-decision-on-the-move.webp?a=1&b=1&s=612x612&w=0&k=20&c=UKdF7StmfHxqV5Tm7yaaq9QuP6iJKkYoS3H4nhGOox4=",
     heading: "Consulting",
          link:"/program/consulting",
      para: `Become a trusted advisor with analytical thinking, strategic insight, and boardroom-ready problem solving` },
  { image: "https://plus.unsplash.com/premium_photo-1661313667772-3cdc7bf2344e?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8YmFua2luZyUyMGFuZCUyMGZpbmFuY2V8ZW58MHx8MHx8fDA%3D",
     heading: "Banking & Finance",
          link:"/program/banking-finance",
      para: ` Navigate the banking & financial landscape with domain depth, regulatory fluency, and technology enabled thinking to spearhead value driven outcomes ` },
  { image: "https://plus.unsplash.com/premium_photo-1688821129380-75c32b3e5918?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8YnVzaW5lc3MlMjBhbmFseXRpY3N8ZW58MHx8MHx8fDA%3D",
     heading: "International Business",
          link:"/program/international-business",
      para: `Turn data into decisions with analytical tools that power business performance and strategic clarity` },
