...
import XELEnterprise from "../../Pages/ExecutiveeduPage/XELEnterprise";
import EEPCxo from "../../Pages/ExecutiveeduPage/EEPCxo";
import EEPPhd from "../../Pages/ExecutiveeduPage/EEPPhd";
import EEPMdps from "../../Pages/ExecutiveeduPage/EEPMdps";
import { useNavigate } from "react-router-dom";
import { useLocation } from "react-router-dom";
import EEPAcademy from "../../Pages/ExecutiveeduPage/EEPAcademy";
import LCPBanner from "../../Pages/LeaderShipCoachPage/LCPBanner";
import "../../Pages/ExecutiveeduPage/EEPage.css";
    ...
    return (
        <div>
            <div className="eep-tabs-wrapper">
                {showLeftArrow && (
                    <button className="eep-tab-arrow left" onClick={() => scrollTabs("left")}>
                        <ChevronLeft />
                    </button>
                )}
                ...
                {showRightArrow && (
                    <button className="eep-tab-arrow right" onClick={() => scrollTabs("right")}>
                        <ChevronRight />
                    </button>
                )}
            </div>
                    ...
                    <SwiperSlide key={index}>
                        ...
                        >
                            <div className="w-100 w-lg-75 w-lg-50 ms-lg-5">
                                <h1 className="fw-bold fs-1 fs-lg-1">{BANNER_HEADINGS[activeTab]}</h1>
                                {BANNER_DESCRIPTIONS[activeTab] && (
                                    <p className="mt-2 mb-3 fs-5">{BANNER_DESCRIPTIONS[activeTab]}</p>
                                )}
